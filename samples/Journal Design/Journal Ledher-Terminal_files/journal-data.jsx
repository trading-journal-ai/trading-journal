...
if (typeof document !== 'undefined' && !document.getElementById('tj-tokens')) {
  ...
  .tj-dark{
    --bg:#0d1117; --surface:#161c26; --surface-2:#1c2430;
    --border:#273040; --hair:rgba(255,255,255,.07);
    --ink:#eef2f7; --body:#c3ccd8; --prose:#a7b2c0; --muted:#727c8a; --faint:#49525f;
    --g:oklch(0.78 0.105 158); --r:oklch(0.69 0.15 27);
    --g-bg:oklch(0.78 0.105 158 / 0.14); --r-bg:oklch(0.69 0.15 27 / 0.14);
    --g-edge:oklch(0.78 0.105 158 / 0.55); --r-edge:oklch(0.69 0.15 27 / 0.55);
    --accent:#7aa9ff;
  }
  .tj-light{
