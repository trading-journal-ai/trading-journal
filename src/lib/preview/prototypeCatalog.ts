...
const inAppMockEntries: PrototypeEntry[] = [
  ...
  {
    id: "/analytics/stats-mock",
    href: "/analytics/stats-mock",
    file: "src/app/(app)/analytics/stats-mock/page.tsx",
    title: "Analytics stats mock",
    description: "Mock of the analytics stats matrix.",
    meta: "In-app mock",
    group: "in-app-mock",
  },
  {
