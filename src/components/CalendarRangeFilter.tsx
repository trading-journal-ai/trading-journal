...
export default function CalendarRangeFilter({
  ...
  return (
    <form ref={rootRef} action="/calendar" className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full z-20 mt-2 w-[calc(100vw-2rem)] max-w-xl rounded-[6px] border border-[var(--border)] bg-[var(--surface)] p-4 shadow-xl md:w-[520px]">
