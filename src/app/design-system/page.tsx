  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="mx-auto w-full max-w-[1180px] px-5 pb-24 pt-8 sm:px-8 sm:pt-12 lg:px-12">
        <header className="pb-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <span className="font-mono text-[10.5px] font-semibold uppercase tracking-[0.16em] text-[var(--muted)]">
              Trading Journal / {labMode ? "Design Lab" : "Design system"}
            </span>
            <Link
              href="/preview"
          ...
          <div className="mt-10 max-w-3xl">
            <h1 className="text-[42px] font-semibold leading-[1.0] tracking-[-0.03em] sm:text-[56px]">
              {labMode ? "Design Lab" : "Design system"}
            </h1>
            <p className="mt-5 text-[16px] leading-7 text-[var(--body)]">
              {labMode ? (
                <>
                  Explore temporary theme and token changes against the real component specimens. Nothing here
                  changes saved preferences or writes back to source; reset or leave the page to discard it.
                </>
              ) : (
                <>
        ...
        <DesignSystemBrowser labMode={labMode} />
      </div>
    </main>
  );
}
