...
import { buildDailyPnl, loadAnalyticsTrades, type ReportTrade } from "@/lib/analyticsTrades";
...
export default async function ReportsPage({
  ...
  const [trades, tagOptions] = await Promise.all([loadAnalyticsTrades({ ...filters, range: dateRangeFor(filters) }, activeAccount.id), loadTagOptions()]);
