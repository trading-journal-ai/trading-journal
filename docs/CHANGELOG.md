...
Local integration (PR pending): Header Import now shows a spinner inside the
...
Local integration (PR pending): Day Coach now places authored trade reviews
...
Local integration (PR pending): Day review formatting now distinguishes the
...
Local integration (PR pending): Day P&L now includes “Review your day” below the
...
Local integration (PR pending): Weekly review flags now link to guided Day Coach
...
Local integration (PR pending): Weekly recap can highlight one green-to-red
...
Local integration (PR pending): Weekly coaching now adds progressive, linked
...
Local fix (PR pending): Removed the independent “other trades” totals beneath
...
Local integration (PR pending): Journal Week now builds from a light Monday/
...
Local integration (PR pending): Journal Week places compact stats above the
