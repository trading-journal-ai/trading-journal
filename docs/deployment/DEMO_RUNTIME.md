> **Restored 2026-07-11** from pre-rewrite history. **Status: STALE** — describes
> the Turso-based demo runtime since removed from `main` (the demo now reads a
> bundled SQLite file). Kept for reference; update to the current runtime or
> retire — see [OWNER_TODO §D](../OWNER_TODO.md).
