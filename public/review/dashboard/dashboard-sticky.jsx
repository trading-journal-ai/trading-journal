...
// ── App ──────────────────────────────────────────────────────────
function DashboardApp({ view, showMarket, density, accent, onSetView, showBoard = true, boardPlacement = 'top' }) {
  ...
  const board = showBoard ? (
    <div style={{ margin: boardPlacement === 'top' ? '0 0 44px' : '52px 0 0', paddingTop: boardPlacement === 'bottom' ? 40 : 0, borderTop: boardPlacement === 'bottom' ? '1px solid var(--hair)' : 'none' }}>
      <StickyBoard />
    </div>
  ) : null;
